...
1) I'm googling some terms, and opening some pages, but somehow after I find a relevant yet not perfect link, I can't find the searching result page that leads me there. Maybe I closed it, or replaced it with another page. Now I want to continue looking through "that" specific search with those exact search terms I used. Instead of trying all those "xxx search" in Firefox history having different keywords I've tried, I can open FromWhereToWhere based on this particular page, find out which searching result page got me here, and open it. NOTE: according to my experience it may take up to 2 minutes before Firefox update its history record.
